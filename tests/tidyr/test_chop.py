...
def test_chop_multiple_columns():
    ...
    assert_frame_equal(out, tibble(x=[1, 2], a=[[1, 2], [3]], b=[[1, 2], [3]]))
...
def test_can_unchop_multiple_cols():
    ...
    assert_frame_equal(out, tibble(x=[1, 2, 2], y=[1, 2, 3], z=[4, 5, 6]))
...
def test_unchopping_null_inputs_are_dropped():
    df = tibble(x=c[1:5], y=[NULL, [1, 2], 4, NULL], z=[NULL, [1, 2], NULL, 5])
