...
@pytest.mark.parametrize(
    "x,nu,exp",
    [
        (Series([0, 1, 2, 3, NA]), 0, [1, 0.765198, 0.223891, -0.260052, NA]),
        (Series([0, 1, 2, 3, NA]), 1, [0, 0.440051, 0.576725, 0.339059, NA]),
        (Series([0, 1, 2, 3, NA]), 2, [0, 0.114903, 0.352834, 0.486091, NA]),
        (
            Series([0, 1, 2, 3, NA]).groupby(list(range(5))),
            0,
            [1, 0.765198, 0.223891, -0.260052, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]).groupby(list(range(5))),
            1,
            [0, 0.440051, 0.576725, 0.339059, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]).groupby(list(range(5))),
            2,
            [0, 0.114903, 0.352834, 0.486091, NA],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            Series([0, 1, 2, 3, NA]),
            0,
            [-Inf, 0.088257, 0.510376, 0.376850, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]),
            1,
            [-Inf, -0.781213, -0.107032, 0.324674, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]),
            2,
            [-Inf, -1.650683, -0.617408, -0.160400, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]).groupby(list(range(5))),
            0,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            0,
            False,
            [1, 1.2660659, 2.2795853, 4.880793, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]),
            1,
            False,
            [0, 0.5651591, 1.5906369, 3.953370, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]),
            2,
            False,
            [0, 0.1357477, 0.6889484, 2.245212, NA],
        ),
        (
            Series([0, 1, 2, 3, NA]).groupby(list(range(5))),
            0,
